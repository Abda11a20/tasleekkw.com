...
const faqs: FAQItem[] = [
  ...
  {
    id: "guarantee",
    question: "هل تقدمون ضمانًا على العمل؟",
    answer:
      "نعم، نقدم ضماناً على جميع أعمالنا. إذا عادت المشكلة بسبب خلل في العمل، نعود لإصلاحها دون أي تكلفة إضافية. رضاك التام هو معيار نجاحنا.",
  },
];
